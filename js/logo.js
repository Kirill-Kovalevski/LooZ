...
(function () {
  ...
  // Define your home page (index.html in the same folder)
  ...
  document.addEventListener('click', function (e) {
    ...
    // Already on home? → do nothing (no reload flicker)
    if (same(location.href, HOME)) return;

    // Came from home and history is available → go back (instant, no repaint)
